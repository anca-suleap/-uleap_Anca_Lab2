...
namespace Șuleap_Anca_Lab2.Data
{
    public class Șuleap_Anca_Lab2Context : DbContext
    {
        ...
        public DbSet<Șuleap_Anca_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Șuleap_Anca_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Șuleap_Anca_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
